...
class WorkorderAdmin(admin.ModelAdmin):
    fields = ['customer', 'workorder', 'internal_company', 'description', 'deadline', 'budget', 'quoted_price', 'original_order', 'billed', 'notes', 'completed', 'total_balance', 'amount_paid', 'open_balance', 'paid_in_full', 'date_billed', 'aging']
