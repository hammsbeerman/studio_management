...
class CustomerForm(forms.ModelForm):
    ...
    class Meta:
        model = Customer
        fields = ['company_name', 'first_name', 'last_name', 'address1', 'address2', 'city', 'state', 'zipcode', 'tax_exempt', 'phone1', 'phone2', 'email', 'website', 'po_number', 'tax_exempt_paperwork', 'active']
        # widgets = {
