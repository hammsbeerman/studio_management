...
class KruegerJobDetail(models.Model):
    ...
    side_2_inktype = models.CharField('Side 2 Ink', choices=[('B/W', 'B/W'), ('Color', 'Color'), ('None', 'None'), ('Vivid', 'Vivid'), ('Vivid Plus', 'Vivid Plus')], max_length=100, blank=False, null=False)
    ...
    step_print_cost_side_2_price = models.CharField('Printing Cost Side 2', max_length=12, blank=True, null=True)
    ...
    step_run_through_duplo = models.CharField('Run through Duplo', max_length=12, blank=True, null=True)
    step_duplo_tasks = models.CharField('Number of tasks', max_length=12, blank=True, null=True)
    step_duplo_price_per_task = models.CharField('Price per task', max_length=12, blank=True, null=True)
    step_duplo_price = models.CharField('Cost for duplo', max_length=12, blank=True, null=True)
    duplo_number_of_pieces = models.CharField('Number of pieces', max_length=12, blank=True, null=True)
    duplo_note = models.CharField('Duplo Note', max_length=100, blank=True, null=True)
    ...
    packaging = models.ForeignKey(Inventory, blank=True, null=True, on_delete=models.SET_NULL, related_name='packaging')
...
class WideFormat(models.Model):
    ...
    material = models.ForeignKey(Inventory, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='material')
    substrate = models.ForeignKey(Inventory, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='substrate')
    laminate = models.ForeignKey(Inventory, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='laminate')
    mask = models.ForeignKey(Inventory, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='mask')
