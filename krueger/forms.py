...
class KruegerJobDetailForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'workorder', 'internal_company', 'customer', 'description', 'qty', 'pages_per_book', 'qty_of_sheets', 'original_size', 'press_size', 'press_sheet_per_parent',
            ...
            'misc3_price', 'misc4_description', 'misc4_price', 'override_price', 'step_run_through_duplo', 'step_duplo_tasks', 'step_duplo_price_per_task', 'step_duplo_price', 'duplo_note'
        ]
        widgets = {
