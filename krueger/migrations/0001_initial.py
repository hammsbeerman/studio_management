# Generated by Django 4.2.9 on 2024-01-18 22:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobquote', models.CharField(choices=[('Workorder', 'Workorder'), ('Quote', 'Quote')], max_length=100, verbose_name='Workorder or Quote')),
                ...
                ('customer', models.ForeignKey(default=2, on_delete=django.db.models.deletion.SET_DEFAULT, to='customers.customer')),
                ('paper_stock', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='krueger.paperstock')),
            ],
        ),
    ]
